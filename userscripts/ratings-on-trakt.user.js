...
(function () {
    ...
    var addIMDbRating = function (rating, votes) {
        ...
        //add IMDb rating to the movie page
    ...
    var addRottenTomatoesRating = function (rating, tomato) {
        ...
        //add Rotten Tomatoes rating to the movie page
        var ratings = document.getElementsByClassName("ratings")[0];
        if (ratings) {
    ...
    var addMetacriticRating = function (rating) {
        ...
        //add Metacritic rating to the movie page
        var ratings = document.getElementsByClassName("ratings")[0];
        if (ratings) {
    ...
    GM_xmlhttpRequest({
        ...
        onload: function (response) {
            ...
            // Rotten Tomatoes
            if (json && json.Ratings[1].Value && json.Ratings[1].Value !== "N/A") {
